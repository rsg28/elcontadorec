...
import './DevolucionImpuestos.css';
...
function DevolucionImpuestos() {
  ...
  return (
    <div className="devolucionimpuestos-page">
      <h1 className="page-title">Devolución de Impuestos</h1>
      {loading ? (
...
export default DevolucionImpuestos; 